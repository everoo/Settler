...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, UITabBarDelegate, AVAudioPlayerDelegate {
    var window: UIWindow?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        do {
            ...
            try audioSession.setInputDataSource(nil)
        ...
        GADMobileAds.configure(withApplicationID: "ca-app-pub-2732851918745448~9060624965")
        return true
    }
